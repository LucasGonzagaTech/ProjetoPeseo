            ...
            <main>
                <container>
                    <div className='geral1'> {/* Div com padding adicionado */}
                        ...
                        <div className='g1sub'>
                            <h1 className='h1subg1'>O jeito grátis, divertido e eficaz de aprender!</h1>

                            <div className='btng1grup'>
                                <Nav className='btng1'>
                                    <Nav.Link href="cadastro" className='btng1Topo'>Comece a aprender agora!</Nav.Link>{/* fazer esse botão ir para a pg de cadastro */}
                                    <Nav.Link href="login" className='btng1baixo'>Já tem conta? Acesse aqui!</Nav.Link>{/* fazer isse botão ir para a pagina de login */}
                                </Nav>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='geral6'>
                        ...
                        <div className='margin'>
                            <div className='aling'>
                                <div className='gp1'>
                                    <img className='imgG6p1' src={imgG6p1} alt='Três pessoas juntas montando lego para representar a construção em equipe' />
                                ...
                                <div className='gp2'>
                                    <img className='imgG6p1' src={imgG6p2} alt='Relogios voando para saber que seu tempo é precioso' />
